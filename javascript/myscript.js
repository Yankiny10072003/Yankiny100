...
theTime.add({
	...
	update: function(percent) {
		...
		document.querySelector('.container .sup').innerHTML= "*Phát hiện tim ai đó đập nhanh 🤭 " + (thePercent+899);
	}
});
theTime.add({
	targets: getHeart,
...
getclickf.addEventListener('click', function(){
	...
	var heyyyy = document.querySelectorAll('.crush path');
...
// Phần popup khi bạn nhấn vào nút "*Phát hiện tim ai đó đập nhanh 🤭"
document.querySelector('.Description .modal-title').innerHTML = '<i class="far fa-comment-alt"></i>&nbsp; Đó là vìiii:';
document.querySelector('.Description .modal-body').innerHTML = 'Vì cô pé đù iu anh rất nhìuuu <i class="fas fa-heart"></i> ';
